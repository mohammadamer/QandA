...
`;
// a styled component for the field container
export const FieldContainer = styled.div`
  margin-bottom: 10px;
`;
// a styled component for the label element
...
export const FieldInput = styled.input`
  ${baseFieldCSS}
`;
// a styled component for the textarea element
export const FieldTextArea = styled.textarea`
  ${baseFieldCSS} height: 100px;
`;
// a styled component for the validation error message
export const FieldError = styled.div`
  font-size: 12px;
  color: red;
`;
// styled component for a container for the form submit button
export const FormButtonContainer = styled.div`
  margin: 30px 0px 0px 0px;
  padding: 20px 0px 0px 0px;
  border-top: 1px solid ${gray5};
`;
// styled components for the submission messages
