...
CREATE PROCEDURE dbo.Answer_Get_ByQuestionId
	@QuestionId int
AS
BEGIN
	SET NOCOUNT ON
...
CREATE PROCEDURE dbo.Answer_Post
	@QuestionId int,
...
CREATE PROCEDURE dbo.Answer_Put
	@AnswerId int,
	@Content nvarchar(max)
AS
BEGIN
...
CREATE PROCEDURE dbo.Question_AddForLoadTest
AS
BEGIN
	DECLARE @i int = 1
...
CREATE PROCEDURE dbo.Question_Exists
	@QuestionId int
AS
BEGIN
	SET NOCOUNT ON
...
CREATE PROCEDURE dbo.Question_GetMany
AS
BEGIN
	SET NOCOUNT ON
...
CREATE PROCEDURE dbo.Question_GetMany_BySearch
	@Search nvarchar(100)
AS
BEGIN
	SET NOCOUNT ON
...
CREATE PROCEDURE dbo.Question_GetMany_BySearch_WithPaging
	@Search nvarchar(100),
	@PageNumber int,
	@PageSize int
AS
...
CREATE PROCEDURE dbo.Question_GetMany_WithAnswers
AS
BEGIN
	SET NOCOUNT ON
...
CREATE PROCEDURE dbo.Question_GetSingle
	@QuestionId int
AS
BEGIN
	SET NOCOUNT ON
...
CREATE PROCEDURE dbo.Question_GetUnanswered
AS
BEGIN
	SET NOCOUNT ON
...
CREATE PROCEDURE dbo.Question_Post
	@Title nvarchar(100),
	@Content nvarchar(max),
	@UserId nvarchar(150),
	@UserName nvarchar(150),
...
CREATE PROCEDURE dbo.Question_Put
	@QuestionId int,
	@Title nvarchar(100),
	@Content nvarchar(max)
AS
...
CREATE PROCEDURE dbo.Answer_Get_ByAnswerId
	@AnswerId int
AS
BEGIN
	SET NOCOUNT ON
